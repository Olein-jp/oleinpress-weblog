...
function op_weblog_scripts() {
	...
	wp_enqueue_script( 'op-weblog-superfish', get_template_directory_uri() . '/src/assets/packages/superfish/js/superfish.min.js', array( 'jquery' ), '1.7.10', true );

	wp_enqueue_script( 'op-weblog-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
